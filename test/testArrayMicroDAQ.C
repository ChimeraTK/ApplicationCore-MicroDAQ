...
typedef boost::fusion::map<
  ...
  , boost::fusion::pair<double, size_t>
  , boost::fusion::pair<bool, size_t>
  , boost::fusion::pair<std::string, size_t>> myMap;
...
myMap m(
    ...
    boost::fusion::make_pair<bool>(5),
    boost::fusion::make_pair<std::string>(6));
